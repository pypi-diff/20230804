# Comparing `tmp/biliarchiver-0.0.34.tar.gz` & `tmp/biliarchiver-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "biliarchiver-0.0.34.tar", max compression
+gzip compressed data, was "biliarchiver-0.0.9.tar", max compression
```

## Comparing `biliarchiver-0.0.34.tar` & `biliarchiver-0.0.9.tar`

### file list

```diff
@@ -1,20 +1,13 @@
--rw-r--r--   0        0        0      131 2023-07-07 09:38:51.631616 biliarchiver-0.0.34/README.md
--rw-r--r--   0        0        0    10861 2023-08-04 11:42:04.410408 biliarchiver-0.0.34/biliarchiver/_biliarchiver_upload_bvid.py
--rw-r--r--   0        0        0    12676 2023-07-27 08:51:31.836489 biliarchiver-0.0.34/biliarchiver/archive_bvid.py
--rw-r--r--   0        0        0     9645 2023-08-04 11:34:54.426941 biliarchiver-0.0.34/biliarchiver/cli_tools/bili_archive_bvids.py
--rw-r--r--   0        0        0     9307 2023-07-28 09:27:19.771125 biliarchiver-0.0.34/biliarchiver/cli_tools/bili_get_bvids.py
--rw-r--r--   0        0        0     2522 2023-07-23 08:20:04.085341 biliarchiver-0.0.34/biliarchiver/cli_tools/bili_upload.py
--rw-r--r--   0        0        0      413 2023-07-07 09:38:51.635616 biliarchiver-0.0.34/biliarchiver/cli_tools/biliarchiver.py
--rw-r--r--   0        0        0     2221 2023-07-20 09:58:51.188806 biliarchiver-0.0.34/biliarchiver/config.py
--rw-r--r--   0        0        0      577 2023-07-27 14:47:04.901042 biliarchiver-0.0.34/biliarchiver/exception.py
--rw-r--r--   0        0        0     3105 2023-08-04 15:04:00.580371 biliarchiver-0.0.34/biliarchiver/utils/dirLock.py
--rw-r--r--   0        0        0      237 2023-07-07 09:38:51.635616 biliarchiver-0.0.34/biliarchiver/utils/ffmpeg.py
--rw-r--r--   0        0        0     1085 2023-07-18 04:24:04.652661 biliarchiver-0.0.34/biliarchiver/utils/http_patch.py
--rw-r--r--   0        0        0     1278 2023-07-07 09:38:51.635616 biliarchiver-0.0.34/biliarchiver/utils/identifier.py
--rw-r--r--   0        0        0      690 2023-07-24 14:21:52.343746 biliarchiver-0.0.34/biliarchiver/utils/storage.py
--rw-r--r--   0        0        0     1606 2023-07-25 18:36:58.299641 biliarchiver-0.0.34/biliarchiver/utils/version_check.py
--rw-r--r--   0        0        0     2745 2023-07-25 18:20:28.861939 biliarchiver-0.0.34/biliarchiver/utils/xml_chars.py
--rw-r--r--   0        0        0       32 2023-08-04 15:04:27.766107 biliarchiver-0.0.34/biliarchiver/version.py
--rw-r--r--   0        0        0      665 2023-08-04 15:04:33.698486 biliarchiver-0.0.34/pyproject.toml
--rw-r--r--   0        0        0     1307 1970-01-01 00:00:00.000000 biliarchiver-0.0.34/setup.py
--rw-r--r--   0        0        0      686 1970-01-01 00:00:00.000000 biliarchiver-0.0.34/PKG-INFO
...
### Comparing `biliarchiver-0.0.34/biliarchiver/_biliarchiver_upload_bvid.py` & `biliarchiver-0.0.9/biliarchiver/_biliarchiver_upload_bvid.py`
...
### Comparing `biliarchiver-0.0.34/biliarchiver/config.py` & `biliarchiver-0.0.9/biliarchiver/config.py`
...
### Comparing `biliarchiver-0.0.34/biliarchiver/utils/dirLock.py` & `biliarchiver-0.0.9/biliarchiver/utils/dirLock.py`
...
### Comparing `biliarchiver-0.0.34/biliarchiver/utils/identifier.py` & `biliarchiver-0.0.9/biliarchiver/utils/string.py`
