# Comparing `tmp/coiled-0.9.6.dev6.tar.gz` & `tmp/coiled-0.9.6.dev7.tar.gz`
...
### Comparing `coiled-0.9.6.dev6/coiled/v2/cluster.py` & `coiled-0.9.6.dev7/coiled/v2/cluster.py`
