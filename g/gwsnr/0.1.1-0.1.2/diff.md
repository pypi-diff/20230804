# Comparing `tmp/gwsnr-0.1.1.tar.gz` & `tmp/gwsnr-0.1.2.tar.gz`
...
## Comparing `gwsnr-0.1.1.tar` & `gwsnr-0.1.2.tar`
...
### Comparing `gwsnr-0.1.1/gwsnr/gwsnr.py` & `gwsnr-0.1.2/gwsnr/gwsnr.py`
...
### Comparing `gwsnr-0.1.1/setup.py` & `gwsnr-0.1.2/setup.py`
