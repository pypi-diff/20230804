# Comparing `tmp/hyko_sdk-0.3.0b5.tar.gz` & `tmp/hyko_sdk-0.3.0b6.tar.gz`
...
## Comparing `hyko_sdk-0.3.0b5.tar` & `hyko_sdk-0.3.0b6.tar`
...
### Comparing `hyko_sdk-0.3.0b5/hyko_sdk/error.py` & `hyko_sdk-0.3.0b6/hyko_sdk/error.py`

 * *Files identical despite different names*

### Comparing `hyko_sdk-0.3.0b5/hyko_sdk/io.py` & `hyko_sdk-0.3.0b6/hyko_sdk/io.py`

 * *Files identical despite different names*

### Comparing `hyko_sdk-0.3.0b5/hyko_sdk/metadata.py` & `hyko_sdk-0.3.0b6/hyko_sdk/metadata.py`

 * *Files identical despite different names*

### Comparing `hyko_sdk-0.3.0b5/hyko_sdk/utils.py` & `hyko_sdk-0.3.0b6/hyko_sdk/utils.py`
