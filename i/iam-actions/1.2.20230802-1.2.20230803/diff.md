# Comparing `tmp/iam_actions-1.2.20230802.tar.gz` & `tmp/iam_actions-1.2.20230803.tar.gz`
 ...
 * *                 "('action', 'BatchGetFindingDetails'), ('condition_keys', []), ('description', "*
